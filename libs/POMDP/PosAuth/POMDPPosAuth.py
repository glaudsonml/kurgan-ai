...
POMDP_FILE="libs/POMDP/PosAuth/posauth.pomdp"
POLICY_FILE="libs/POMDP/Posauth/posauth.policy"


class POMDP_PosAuthentication(object):
    actions = ['run_spider', 'run_get_parameters', 'run_attack']
    states = ['initial', 'with_urls','without_parameters','with_parameters']
