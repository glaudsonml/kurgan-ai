...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>Kurgan - Web Application Security Scanner</title>
	...
	<body>
		...
		<h1 id="head">
			...
			<div class="areaTexto">
				&nbsp;&nbsp;Kurgan - Web Application Security Scanner
			</div>
		</h1>
		...
		<ul id="navigation">
			...
			<div id="content" class="container_16 clearfix" align="center">
				<div class="grid_18">
					 <div class="box">
                                                <h2>Add User</h2>
                                                <form action="/controller/ctl_user.php" method="post">
                                                        <p>
                                                                <label for="post">Login: </label>
